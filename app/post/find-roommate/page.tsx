...
export default function FindRoommate() {
  ...
  const validate = () => {
    const newErrors: any = {};
    if (!form.type) newErrors.type = "Select a hostel type.";
    if (!form.gender) newErrors.gender = "Select gender preference.";
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      const res = await fetch("/api/listings", {
        ...
        body: JSON.stringify({ ...form, formType: "find-roommate" }),
      });
